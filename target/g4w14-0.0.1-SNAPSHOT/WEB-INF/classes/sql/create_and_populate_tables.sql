...
CREATE TABLE order_details(
	...
	PRIMARY KEY (_id),
	CONSTRAINT books_order_details_id_fk FOREIGN KEY(books_id) REFERENCES books(_id),
...
CREATE TABLE invoice(
	...
	pst DECIMAL(5,2) NOT NULL default 0,
	gst DECIMAL(5,2) NOT NULL default 0,
	hst DECIMAL(5,2) NOT NULL default 0,
...
/* ***************** I WANT TO DELETE TABLE: 'surveys' ********************  */
/* ***************** AND REPLACE WITH 'survey_questions' & 'survey_answers' ********************  */
/* ***************** ALLOWS FOR AS LITTLE AS 1 TO AS MANY AS INFINITE AMOUNT OF ANSWERS ********************  */
