...
public class SearchAction implements Serializable {
	...
	/*
	 * Main method called when search button clicked / * @author Matthieu
	 */
	 ...
	 * @author Polina
	 */
	public String searchActionMobile() throws SQLException {
		/**
		 * Get the id from facesContext
		 */
		FacesContext fc = FacesContext.getCurrentInstance();
		...
		return navBean.toMobile();
	}

	/*
	 * Special search for management side
	 * 
	 * @author Matthieu
	 */
